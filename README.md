...
**IMPORTANT**: The library's import path is based on its original location under `github.com/pushself`. Do not try to import it as `github.com/jaegertracing`, it will not compile. We might revisit this in the next major release.
  * :white_check_mark: `import "github.com/pushself/jaeger-client-go"`
...
```toml
[[constraint]]
  name = "github.com/pushself/jaeger-client-go"
  version = "2.17"
```
...
```shell
go get -u github.com/pushself/jaeger-client-go/
cd $GOPATH/src/github.com/pushself/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/github.com/pushself/jaeger-client-go/config#pkg-examples)
...
Besides the [zap](https://github.com/pushself-go/zap) implementation
...
[doc-img]: https://godoc.org/github.com/pushself/jaeger-client-go?status.svg
[doc]: https://godoc.org/github.com/pushself/jaeger-client-go
