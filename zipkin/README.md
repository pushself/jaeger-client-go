...
If you'd like to follow the official guides from https://godoc.org/github.com/pushself/jaeger-client-go/config#example-Configuration-InitGlobalTracer-Production, here is an example.
